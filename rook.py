...
def black_rook(x,y,wpa,wpb,wpc,wpd,wpe,wpf,wpg,wph,bpa,bpb,bpc,bpd,bpe,bpf,bpg,bph,wra,wrh,bra,brh,wq,bq,wk,bk,bng,bnb,wnb,wng,wbc,wbf,bbc,bbf):
  ...
  for i in [1,2,3,4,5,6,7,8]:
    if Open.isblockedw(x,y+i,wpa,wpb,wpc,wpd,wpe,wpf,wpg,wph,wra,wnb,wbc,wq,wk,wbf,wng,wrh)==True:
      moves.append(pos)
      end=(x,y+i)
      moves.append(end)
      break
  ...
  for i in [1,2,3,4,5,6,7,8]:
    if Open.isblockedw(x,y-i,wpa,wpb,wpc,wpd,wpe,wpf,wpg,wph,wra,wnb,wbc,wq,wk,wbf,wng,wrh)==True:
      ...
      moves.append(end)
  for i in [1,2,3,4,5,6,7,8]:
    if Open.isblockedw(x+i,y,wpa,wpb,wpc,wpd,wpe,wpf,wpg,wph,wra,wnb,wbc,wq,wk,wbf,wng,wrh)==True:
      moves.append(pos)
      end=(x+i,y)
      moves.append(end)
      break
